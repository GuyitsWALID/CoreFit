...
const DEFAULT_GYM: GymConfig = {
  ...
  address: 'Sample Street, Atlanta, GA 30309, United States',
  ...
  latitude: 33.7490,
  longitude: -84.3880,
  description: 'A modern fitness facility with state-of-the-art equipment and professional trainers.',
  status: 'active',
